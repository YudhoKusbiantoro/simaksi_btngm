...
<body
    ...
    <header class="w-full max-w-7xl mx-auto px-4 lg:px-8 text-sm mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
    ...
    <div
        ...
        <main class="flex w-full max-w-7xl mx-auto px-4 lg:px-8 flex-col-reverse lg:flex-row">
            <div
            ...
            <div
                class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-1/2 shrink-0 overflow-hidden">
                {{-- Laravel Logo --}}
                ...
                {{-- Light Mode 12 SVG --}}
                <svg class="w-full h-auto relative -mt-[4.9rem] -ml-8 lg:ml-0 lg:-mt-[6.6rem] dark:hidden"
                ...
                {{-- Dark Mode 12 SVG --}}
                <svg class="w-full h-auto relative -mt-[4.9rem] -ml-8 lg:ml-0 lg:-mt-[6.6rem] hidden dark:block"
                    viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g
                        class="transition-all delay-300 translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-4">
                        <path
