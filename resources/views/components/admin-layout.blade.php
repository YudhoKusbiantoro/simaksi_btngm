...
<body class="bg-slate-100 min-h-screen flex">
    ...
    <div x-data="{ sidebarOpen: false }" class="flex-1 flex flex-col md:flex-row min-h-screen">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            class="fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-green-900 to-green-800 text-white flex flex-col shadow-xl transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:inset-auto">

            <!-- LOGO -->
            <div class="px-6 py-5 flex items-center gap-3 border-b border-green-700 relative">
                ...
                <button @click="sidebarOpen = false"
                    class="absolute right-4 top-1/2 -translate-y-1/2 md:hidden text-green-200 hover:text-white">
        ...
        <div class="flex-1 flex flex-col min-w-0 transition-all duration-300">
            <!-- Mobile Toggle -->
            <div class="md:hidden bg-white shadow-sm p-4 flex items-center gap-3">
                <button @click="sidebarOpen = true" class="text-gray-600 hover:text-green-700">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 6h16M4 12h16M4 18h16" />
                    </svg>
                </button>
                <span class="font-bold text-green-900">Admin Panel</span>
            </div>
